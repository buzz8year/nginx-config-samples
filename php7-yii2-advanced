server {
    ...
    location ~ \.php$ {
        ...
        # check the www.conf file to see if PHP-FPM is listening on a socket or port fastcgi_pass 127.0.0.1:9000; fastcgi_split_path_info ^(.+\.php)(/.+)$;
    ...
    location ~ \.(css|less|ttf|otf|woff|woff2|js|jpg|jpeg|png|gif|bmp|ico|mov|swf|pdf|zip|rar)$ {
